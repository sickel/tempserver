...
PORT = /dev/tttACM0
#
# Set target to name of application (without extention):
#
TARGET = WebServer_temp_multi
# Probably for mac:
# ARDUINO = /Applications/arduino-0005/lib/targets/arduino 
# Debian linux: (do "locate HardwareSerial.cpp" to find the right directory)
ARDUINO =/usr/share/arduino/hardware/arduino/cores/arduino

ARDUINOVARIANT=/usr/share/arduino/hardware/arduino/variants/standard
...
CINCS = -I$(ARDUINO) -I$(ARDUINOVARIANT)
CXXINCS = -I$(ARDUINO) -I$(ARDUINOVARIANT)
...
build: elf hex eepHardwareSerial.cpp
